...
def parse_args():
    ...
    parser.add_argument('-v', dest='version', type=str, help='version of new encoder and decoder, e.g. \'1.0\'',
                        required=True)
    parser.add_argument('-vs', dest='versions', type=str,
                        help='comma separated versions that should be also compared to the new encoder and decoder version, e.g. \'1.0,2.0\'',
                        required=False)
